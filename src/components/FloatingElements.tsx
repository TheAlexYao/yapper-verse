  ...
  return (
    <div ref={containerRef} className="fixed inset-0 pointer-events-none overflow-hidden">
      ...
      <div className={cn(
        ...
        "bg-[url('/photo-1504893524553-b855bce32c67')] bg-cover bg-center",
        "top-[20%] left-[15%] opacity-20 transition-transform duration-300 blur-sm"
      )} />
      <div className={cn(
        "floating-element absolute w-48 h-48 rounded-full",
        "bg-[url('/photo-1501854140801-50d01698950b')] bg-cover bg-center",
      ...
      <div className={cn(
        ...
        "bg-[url('/photo-1465146344425-f00d5f5c8f07')] bg-cover bg-center",
      ...
      <div className={cn(
        ...
        "bg-[url('/photo-1470071459604-3b5ec3a7fe05')] bg-cover bg-center",
