  ...
  return (
    <section id="how-it-works" className="py-20 relative overflow-hidden">
      <div className="container mx-auto px-4 relative">
        <h2 className="text-4xl md:text-6xl font-bold text-center mb-16 bg-gradient-to-r from-[#38b6ff] to-[#7843e6] bg-clip-text text-transparent">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <div key={item.step} className="relative animate-fadeIn opacity-0" style={{ animationDelay: `${0.2 * (index + 1)}s` }}>
              <div className="absolute -top-4 left-4 md:left-8 w-10 h-10 rounded-full bg-gradient-to-r from-[#38b6ff] to-[#7843e6] flex items-center justify-center text-white text-xl font-bold z-10">
                {item.step}
              </div>
              <div className="p-8 rounded-lg bg-gradient-to-br from-white/5 to-white/10 border border-white/10 backdrop-blur-sm h-full hover:scale-105 transform transition-all duration-300">
