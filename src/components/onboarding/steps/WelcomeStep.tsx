...
export function WelcomeStep({ onNext }: WelcomeStepProps) {
  return (
    <div className="space-y-4 animate-fadeIn">
      <h1 className="text-4xl font-bold bg-gradient-to-r from-[#38b6ff] to-[#38b6ff]/70 bg-clip-text text-transparent">
      ...
      <Button onClick={onNext} className="w-full md:w-auto bg-[#38b6ff] hover:bg-[#38b6ff]/90">
        Let's Begin
      </Button>
    </div>
  );
